...
export default function Hero() {
  return (
    ...
    <section id="hero" 
   className="relative flex min-h-screen items-center pl-8 pr-100 pt-20">

      {/* Left Content */}
      {/*Availability Badge*/}
      <div className="relative -top-10 max-w-3xl">
      <div className="mb-6 -ml-2 inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white/60 px-5 py-2.5 text-sm font-medium tracking-wide text-gray-600 shadow-[0_0_18px_rgba(34,197,94,0.15)] backdrop-blur-sm transition-all duration-300 hover:shadow-[0_0_24px_rgba(34,197,94,0.25)] dark:border-[#374151] dark:bg-[#151B28]/60 dark:text-gray-300">
       ...
       <p className="text-lg font-medium text-gray-700 dark:text-gray-400">
        ...
        <h1 className="mt-2 text-5xl font-extrabold tracking-tight text-black dark:text-white">
            I'm Mayank Kulkarni
        </h1>
      ...
      <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-700 dark:text-gray-400">
...
>
  ...
  {/* Social Icons */}
  <div className="mt-8 -mr-10 flex items-center gap-6">
    <a
  ...
  {/* Right Image */}
<div className="absolute -right-10 top-48/100 z-10 -translate-y-1/2">
{/* Animated Glow */}
  ...
  <img
    src="/medium.jpg"
    alt="Mayank Kulkarni"
    className="h-[420px] w-[400px] rounded-3xl object-cover"
  />
</div>
