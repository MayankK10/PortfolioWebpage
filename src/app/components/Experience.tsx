      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 space-y-8">
          {experiences.map((exp) => (
            <div
              key={exp.role}
              className="grid grid-cols-1 gap-8 rounded-3xl border border-[#D2D6E0] bg-[#F1F3F8] p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-[#293142] dark:bg-[#121824] md:grid-cols-12 md:p-8"
            >
              ...
              <div className="min-w-0 text-left md:col-span-10 md:text-left">
                ...
                <ul className="mx-auto mt-6 max-w-3xl space-y-3 text-left text-gray-900 dark:text-gray-400 md:mx-0 md:max-w-none">
